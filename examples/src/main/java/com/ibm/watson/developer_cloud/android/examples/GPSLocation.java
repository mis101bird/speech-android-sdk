...
public class GPSLocation {
     ...
     */
    public GPSLocation(final Context context, final boolean requireFine) {
     ...
     */
    public GPSLocation(final Context context, final boolean requireFine, final boolean passive) {
     ...
     */
    public GPSLocation(final Context context, final boolean requireFine, final boolean passive, final long interval) {
     ...
     */
    public GPSLocation(final Context context, final boolean requireFine, final boolean passive, final long interval, final boolean requireNewLocation) {
